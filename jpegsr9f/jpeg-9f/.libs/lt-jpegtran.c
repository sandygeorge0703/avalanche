...
const char * LIB_PATH_VALUE = "C:/Users/Sandhra George/avalanche/jpegsr9f/jpeg-9f/.libs";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "\\c\\Users\\Sandhra:George\\avalanche\\jpegsr9f\\jpeg-9f\\.libs:\\mingw64\\lib:\\mingw64\\bin;";
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.7\n");
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("# Generated by libtool (GNU libtool) 2.4.7\n", f);
  fputs ("#\n", f);
  ...
  fputs ("  generated_by_libtool_version='2.4.7'\n", f);
  ...
  fputs ("    echo \"jpegtran.exe:jpegtran:$LINENO: libtool wrapper (GNU libtool) 2.4.7\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"jpegtran.exe:jpegtran:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"jpegtran.exe:jpegtran:$LINENO: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
  ...
  fputs ("    PATH=/c/Users/Sandhra:George/avalanche/jpegsr9f/jpeg-9f/.libs:/mingw64/lib:", f);
  fputs ("/mingw64/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/c/Users/Sandhra George/avalanche/jpegsr9f/jpeg-9f/.libs:$PATH\"\n", f);
  fputs ("\n", f);
